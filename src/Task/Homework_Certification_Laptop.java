...
public class Homework_Certification_Laptop {
    ...
    public Homework_Certification_Laptop (String model,Integer id, String brand){ //Создаём конструктор в который передаём параметры: модели, id, бренд
        this.model = model;
        this.brand = brand;
        this.id = id;
